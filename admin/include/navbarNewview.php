            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul id="newNav">
                    ...
                    <li><a href="javascript:void(0);"><i class='far fa-eye'></i> View</a>
                        <ul>
                            <li><a href="viewproduct.php"><i class='far fa-eye'></i> Product</a></li>
                            <li><a href="viewcategory.php"><i class='far fa-eye'></i> Category</a></li>
                            <li><a href="viewsubcategory.php"><i class='far fa-eye'></i> Sub.Cat</a></li>
                        </ul>
                    </li>
